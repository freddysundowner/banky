...
./install.sh`}</CodeBlock>
          ...
          <div className="border-l-4 border-purple-500 pl-6">
            ...
            <p className="text-gray-600 mb-4">
              The installer writes a working <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">.env</code> automatically. You only need to edit it if you want to change defaults or add optional integrations:
            </p>
            <CodeBlock>{`nano .env`}</CodeBlock>
            <p className="text-gray-600 mt-4 mb-3">Common settings to review:</p>
...
MPESA_CONSUMER_SECRET=your_secret`}</CodeBlock>
          </div>
