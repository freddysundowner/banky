...
def update_landing_page_settings(data: dict, admin: AdminUser = Depends(require_admin), db: Session = Depends(get_db)):
    ...
    allowed_keys = [
        ...
        "landing_docs_support_email",
        "landing_show_subscription_content",
        "landing_docs_mode",
...
def initial_setup(data: dict, db: Session = Depends(get_db)):
    ...
    if existing_plans == 0:
        from main import _seed_business_type_plans
...
DEFAULT_PLATFORM_SETTINGS = [
    ...
    {"key": "subscription_mpesa_consumer_key", "value": "", "type": "string", "description": "Daraja API consumer key for processing subscription M-Pesa payments"},
    {"key": "subscription_mpesa_consumer_secret", "value": "", "type": "string", "description": "Daraja API consumer secret for processing subscription M-Pesa payments"},
    {"key": "subscription_mpesa_passkey", "value": "", "type": "string", "description": "Daraja API passkey for processing subscription M-Pesa payments"},
    {"key": "subscription_mpesa_shortcode", "value": "", "type": "string", "description": "M-Pesa shortcode (paybill/till) for processing subscription payments"},
