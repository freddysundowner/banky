...
DEFAULT_SETTINGS = [
    ...
    {"key": "mpesa_stk_callback_url", "value": "", "type": "string", "description": "M-Pesa STK Push callback URL"},
    {"key": "mpesa_initiator_name", "value": "", "type": "string", "description": "M-Pesa B2C initiator name"},
    {"key": "mpesa_security_credential", "value": "", "type": "string", "description": "M-Pesa B2C security credential"},
