...
class SubscriptionPlan(Base):
    ...
    pricing_model = Column(String(20), default="saas")
    monthly_price = Column(Numeric(10, 2), default=0)
    annual_price = Column(Numeric(10, 2), default=0)
    usd_monthly_price = Column(Numeric(10, 2), default=0)
    usd_annual_price = Column(Numeric(10, 2), default=0)
    ngn_monthly_price = Column(Numeric(10, 2), default=0)
    ngn_annual_price = Column(Numeric(10, 2), default=0)
    one_time_price = Column(Numeric(10, 2), default=0)
    ...
    support_years = Column(Integer, default=1)
...
class SubscriptionPayment(Base):
    ...
    paystack_access_code = Column(String(255))
...
class Organization(Base):
    ...
    deployment_mode = Column(String(50), default="saas")
    ...
    require_clock_in = Column(Boolean, default=False)
    allow_weekend_access = Column(Boolean, default=True)
    timezone = Column(String(100), default="Africa/Nairobi")
