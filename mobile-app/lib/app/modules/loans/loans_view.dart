...
class LoansView extends GetView<LoansController> {
  ...
  Widget _buildSoftLoanBanner() {
    return GestureDetector(
      onTap: () => Get.toNamed(Routes.softLoan),
      child: Container(
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Check your limit and borrow instantly',
  ...
  Widget _buildStatusBadge(loan) {
    ...
    } else if (loan.statusLabel.toLowerCase() == 'completed') {
